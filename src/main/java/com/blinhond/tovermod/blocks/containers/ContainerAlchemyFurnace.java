package com.blinhond.tovermod.blocks.containers;
...
public class ContainerAlchemyFurnace extends Container {
    ...
    public ContainerAlchemyFurnace(InventoryPlayer player, TileEntityAlchemistFurnace tileentity) {
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index == 3) {
                ...
                if (!AlchemistFurnaceRecipes.getInstance().getSmeltingResult(stack1, slot1.getStack()).isEmpty()) {
                    if (!this.mergeItemStack(stack1, 0, 2, false)) {
                        return ItemStack.EMPTY;
                    } else if (TileEntityAlchemistFurnace.isItemFuel(stack1)) {
